<%-- 
    Document   : aquarium
    Created on : 04-Nov-2013, 00:41:30
    Author     : Jieqiong
--%>
...
<html>
    ...
    <body>
        ...
        <ul>
            <li>
                <h3>Underwater Aquarium Tickets</h3>
                <p>Purchase your day passes to the Underwater World Aquarium online and save time queuing when you arrive at the museum.<br />
                ...
                <table class="styled" cellpadding="0" cellspacing="0" border="1" width="100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">$<%=tickets.get(24).getAttrTicketPrice()%></td>
                            <td style="text-align: center;">$<%=tickets.get(26).getAttrTicketPrice()%></td>
                            <td style="text-align: center;">$<%=tickets.get(28).getAttrTicketPrice()%></td>
                        </tr>
                        <tr>
                            <td class="subhead" style="text-align: left;">Annual Pass<br />
                            <td style="text-align: center;">$<%=tickets.get(25).getAttrTicketPrice()%></td>
                            <td style="text-align: center;">$<%=tickets.get(27).getAttrTicketPrice()%></td>
                            <td style="text-align: center;">$<%=tickets.get(29).getAttrTicketPrice()%></td>
                        </tr>
                    </tbody>
                </table>
