...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#d6e5e4","bg_over":"#EFEFEF","bg_out":"#579c98"}
};
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #579c98;width:200px;height:216px;">');
...
__ci.document.writeln('th.theader {font-weight:normal;background-color:#579c98;color:#FFFFFF;width:24px;}');
