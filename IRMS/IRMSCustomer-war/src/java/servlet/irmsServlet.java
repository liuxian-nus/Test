    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("restaurantSearch".equals(page)) {
                ...
                request.getRequestDispatcher("/CRMServlet/memberPromotionPurchase").forward(request, response);
            ...
            } else if ("eventVenue1".equals(page)) {
                request.getRequestDispatcher("/CEMSServlet/eventVenue1").forward(request, response);
