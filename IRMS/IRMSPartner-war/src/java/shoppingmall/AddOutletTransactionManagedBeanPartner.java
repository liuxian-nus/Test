...
@ManagedBean
@ViewScoped
public class AddOutletTransactionManagedBeanPartner {
    ...
    private Long itemId;
    private static final Logger logger = Logger.getLogger(AddOutletTransactionManagedBeanPartner.class.getName());
    private MemberTransactionEntity mtransaction;

    /**
     * Creates a new instance of AddOutletTransactionManagedBean
     */
    public AddOutletTransactionManagedBeanPartner() {
    ...
    public void addTransaction(ActionEvent event) throws ExistException {
        ...
        try {
            ...
            FacesContext.getCurrentInstance().getExternalContext().getFlash().put("thisOutlet", outlet);
